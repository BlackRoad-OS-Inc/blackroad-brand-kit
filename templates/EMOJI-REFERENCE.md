...
| 🤖 | AI agent | Automated agent action |
| 🧑‍⚖️ | Decision maker | Approval needed, governance |
| 🙋 | Volunteer/contributor | Open for contributors |
...
| Emoji | Meaning | Usage |
|-------|---------|-------|
| 📅 | Date/scheduled | Calendar event, milestone |
| ⏰ | Alarm/deadline | Time-sensitive, countdown |
| 🕐 | Specific time | Exact timestamp reference |
| 🗓 | Sprint/period | Sprint boundary, quarterly |
| ⏱ | Timer/benchmark | Performance timing |
| 🌙 | Off-hours/maintenance | Night deploy, maintenance window |
| ☀️ | Business hours | Daytime ops, normal operations |
...
| Emoji | Meaning | Usage |
|-------|---------|-------|
| 📊 | Dashboard/metrics | Grafana, analytics, KPIs |
| 📈 | Trend up | Positive metric, growth |
| 📉 | Trend down | Negative metric, decline |
