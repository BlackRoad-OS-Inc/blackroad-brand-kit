    ...
    >
      ...
      <div
        style={{
          ...
          background: GRAD,
          boxShadow:
            "0 0 30px rgba(255,107,43,0.2), 0 0 80px rgba(0,212,255,0.08)",
        }}
      />
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          <div
            style={{
              ...
              marginBottom: 16,
              textShadow: `0 0 12px ${colors[0].hex}40`,
            }}
          >
        ...
        >
          ...
          <div
            style={{
              ...
              background: GRAD,
              boxShadow:
                "0 0 40px rgba(255,107,43,0.15), 0 0 80px rgba(0,212,255,0.08)",
            }}
          />
          <div
            style={{
        ...
        >
          ...
          {colors.map((c, i) => (
            ...
            >
              ...
              <span
                style={{ fontSize: "0.46rem", color: c.hex, opacity: 0.6 }}
              >
                {c.hex}
              </span>
              <span
        ...
        >
          ...
          {[
            ...
            {
              label: "Warm (Orange → Magenta)",
              grad: `linear-gradient(90deg, ${colors[0].hex}, ${colors[1].hex}, ${colors[2].hex})`,
            },
            {
              label: "Cool (Purple → Cyan)",
              grad: `linear-gradient(90deg, ${colors[3].hex}, ${colors[4].hex}, ${colors[5].hex})`,
            },
            {
              label: "Fire (Orange → Red)",
              grad: `linear-gradient(90deg, ${colors[0].hex}, ${colors[1].hex})`,
            },
            {
              label: "Electric (Blue → Cyan)",
              grad: `linear-gradient(90deg, ${colors[4].hex}, ${colors[5].hex})`,
            },
            {
              label: "Violet (Red → Purple)",
              grad: `linear-gradient(90deg, ${colors[1].hex}, ${colors[2].hex}, ${colors[3].hex})`,
            },
          ].map((g, i) => (
            <div key={i} style={{ marginBottom: 12 }}>
              <div
                style={{
                  height: 28,
                  background: g.grad,
                  boxShadow: "0 0 16px rgba(255,107,43,0.08)",
                }}
              />
              <div
                style={{ fontSize: "0.42rem", color: textDim, marginTop: 4 }}
              >
                {g.label}
              </div>
            </div>
